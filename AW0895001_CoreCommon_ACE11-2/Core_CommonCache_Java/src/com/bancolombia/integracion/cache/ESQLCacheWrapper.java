...
/**
 * Cache optimizada para ser usada desde ESQL
 * 
 * @author hrengifo
 *
 */
public class ESQLCacheWrapper {
	private static Map<String, ICache<String, String>> cacheInstances;

	static {
		cacheInstances = new ConcurrentHashMap<String, ICache<String, String>>(
				10, 0.75f);
	}
	...
	public static Boolean init(String properties, String cache) {
		...
		ICache<String, String> cacheInstace = CacheFactory
				.getCacheInstance(cacheProperties);
	...
	protected static Properties parseProperties(final String properties,
